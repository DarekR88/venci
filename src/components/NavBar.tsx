  ...
  return (
    <main>
      ...
      >
        <Link
          href={"/"}
          className="font-Playfair flex flex-col rounded-full lg:flex-row lg:justify-center tracking-widest text-xl z-0 px-4 bg-gradient-to-r from-cOne to-cSeven"
        >
