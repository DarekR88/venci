  ...
  return (
    <main className="lg:max-w-[1200px] m-auto px-2 lg:pt-[162px]">
      ...
      <div className="mb-[50px] lg:pl-10">
        ...
        <Link
          href={"/contact"}
          className="flex w-fit font-Montserrat shadow-xl text-center text-xl ml-[250px] p-[10px] bg-white border-2 border-cFive rounded-md mt-[30px] hover:bg-cFive hover:border-transparent hover:shadow-none hover:scale-105 transition-all duration-300"
        >
      ...
      <div className="lg:pl-10">
        ...
        <div className="flex flex-col lg:flex-row mb-[50px] gap-10 lg:gap-12">
        ...
        <Link
          href={"/contact"}
          className="flex w-fit lg:mb-[100px] font-Montserrat shadow-xl text-center text-xl ml-[250px] p-[10px] bg-white border-2 border-cSeven rounded-md mt-[30px] hover:bg-cSeven hover:border-transparent hover:shadow-none hover:scale-105 transition-all duration-300"
        >
          Book a Free Consultation Today &#8669;
        </Link>
      </div>
